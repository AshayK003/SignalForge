...
class Transcriber:
    def __init__(
        self, model_size: str = "base", device: str = "cpu", compute_type: str = "float32", logger: Any = None
    ):
    ...
    def save_transcript(self, result: dict, output_dir: str | Path, source_id: int | str) -> dict[str, str]:
